...
// checks if the HostsGET type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostsGET{}

// HostsGET This model contains host information.
type HostsGET struct {
	// Host information
...
func (o HostsGET) MarshalJSON() ([]byte, error) {
...
func (o HostsGET) ToMap() (map[string]interface{}, error) {
...
func (o *HostsGET) UnmarshalJSON(data []byte) (err error) {
	...
	varHostsGET := _HostsGET{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHostsGET)

	if err != nil {
		return err
	}

	*o = HostsGET(varHostsGET)

	return err
}

type NullableHostsGET struct {
	value *HostsGET
	isSet bool
}

func (v NullableHostsGET) Get() *HostsGET {
	return v.value
}

func (v *NullableHostsGET) Set(val *HostsGET) {
	v.value = val
	v.isSet = true
}

func (v NullableHostsGET) IsSet() bool {
	return v.isSet
}

func (v *NullableHostsGET) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostsGET(val *HostsGET) *NullableHostsGET {
	return &NullableHostsGET{value: val, isSet: true}
}

func (v NullableHostsGET) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostsGET) UnmarshalJSON(src []byte) error {
	v.isSet = true
