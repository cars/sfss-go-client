...
func NewGetRedfishV1SFSSAppAlertsAlertId201Response(cdcInstances []interface{}, identifier string, odataContext string, odataId string, protocol string, context string, eventTypes []interface{}, odataType string, httpHeaders []interface{}, destination string) *GetRedfishV1SFSSAppAlertsAlertId201Response {
	this := GetRedfishV1SFSSAppAlertsAlertId201Response{}
...
func (o *GetRedfishV1SFSSAppAlertsAlertId201Response) GetCdcInstancesOk() ([]interface{}, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *GetRedfishV1SFSSAppAlertsAlertId201Response) GetOdataIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *GetRedfishV1SFSSAppAlertsAlertId201Response) GetEventTypesOk() ([]interface{}, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *GetRedfishV1SFSSAppAlertsAlertId201Response) GetDestinationOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o GetRedfishV1SFSSAppAlertsAlertId201Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetRedfishV1SFSSAppAlertsAlertId201Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRedfishV1SFSSAppAlertsAlertId201Response := _GetRedfishV1SFSSAppAlertsAlertId201Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRedfishV1SFSSAppAlertsAlertId201Response)

	if err != nil {
		return err
	}

	*o = GetRedfishV1SFSSAppAlertsAlertId201Response(varGetRedfishV1SFSSAppAlertsAlertId201Response)

	return err
}

type NullableGetRedfishV1SFSSAppAlertsAlertId201Response struct {
	value *GetRedfishV1SFSSAppAlertsAlertId201Response
	isSet bool
}

func (v NullableGetRedfishV1SFSSAppAlertsAlertId201Response) Get() *GetRedfishV1SFSSAppAlertsAlertId201Response {
	return v.value
}

func (v *NullableGetRedfishV1SFSSAppAlertsAlertId201Response) Set(val *GetRedfishV1SFSSAppAlertsAlertId201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRedfishV1SFSSAppAlertsAlertId201Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRedfishV1SFSSAppAlertsAlertId201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRedfishV1SFSSAppAlertsAlertId201Response(val *GetRedfishV1SFSSAppAlertsAlertId201Response) *NullableGetRedfishV1SFSSAppAlertsAlertId201Response {
	return &NullableGetRedfishV1SFSSAppAlertsAlertId201Response{value: val, isSet: true}
}

func (v NullableGetRedfishV1SFSSAppAlertsAlertId201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRedfishV1SFSSAppAlertsAlertId201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
