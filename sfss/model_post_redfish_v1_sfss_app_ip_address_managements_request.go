...
type _PostRedfishV1SFSSAppIpAddressManagementsRequest PostRedfishV1SFSSAppIpAddressManagementsRequest
...
func NewPostRedfishV1SFSSAppIpAddressManagementsRequest(iPV4Address []string, iPV4Config string, iPV4Gateway string, iPV4PrefixLength float32, iPV6Config string, iPV6Address []string, iPV6Gateway string, iPV6PrefixLength float32, parentInterface string, vlanId float32) *PostRedfishV1SFSSAppIpAddressManagementsRequest {
	this := PostRedfishV1SFSSAppIpAddressManagementsRequest{}
...
func (o PostRedfishV1SFSSAppIpAddressManagementsRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostRedfishV1SFSSAppIpAddressManagementsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostRedfishV1SFSSAppIpAddressManagementsRequest := _PostRedfishV1SFSSAppIpAddressManagementsRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostRedfishV1SFSSAppIpAddressManagementsRequest)

	if err != nil {
		return err
	}

	*o = PostRedfishV1SFSSAppIpAddressManagementsRequest(varPostRedfishV1SFSSAppIpAddressManagementsRequest)

	return err
}

type NullablePostRedfishV1SFSSAppIpAddressManagementsRequest struct {
	value *PostRedfishV1SFSSAppIpAddressManagementsRequest
	isSet bool
}

func (v NullablePostRedfishV1SFSSAppIpAddressManagementsRequest) Get() *PostRedfishV1SFSSAppIpAddressManagementsRequest {
	return v.value
}

func (v *NullablePostRedfishV1SFSSAppIpAddressManagementsRequest) Set(val *PostRedfishV1SFSSAppIpAddressManagementsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostRedfishV1SFSSAppIpAddressManagementsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostRedfishV1SFSSAppIpAddressManagementsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostRedfishV1SFSSAppIpAddressManagementsRequest(val *PostRedfishV1SFSSAppIpAddressManagementsRequest) *NullablePostRedfishV1SFSSAppIpAddressManagementsRequest {
	return &NullablePostRedfishV1SFSSAppIpAddressManagementsRequest{value: val, isSet: true}
}

func (v NullablePostRedfishV1SFSSAppIpAddressManagementsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostRedfishV1SFSSAppIpAddressManagementsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
