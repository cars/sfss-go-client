...
func Test_sfssapp_DefaultAPIService(t *testing.T) {
	...
	t.Run("Test DefaultAPIService DeleteRedfishV1SFSSAppCDCInstanceManagers", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.DefaultAPI.DeleteRedfishV1SFSSAppCDCInstanceManagers(context.Background(), instanceId).Execute()
	...
	t.Run("Test DefaultAPIService DeleteRedfishV1SFSSAppIpAddressManagementsInterface", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var interfaceId string

		httpRes, err := apiClient.DefaultAPI.DeleteRedfishV1SFSSAppIpAddressManagementsInterface(context.Background(), interfaceId).Execute()
	...
	t.Run("Test DefaultAPIService GetRedfishV1SFSSAppIpAddressManagementsInterface", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.DefaultAPI.GetRedfishV1SFSSAppIpAddressManagementsInterface(context.Background(), interfaceId).Execute()
	...
	t.Run("Test DefaultAPIService PutRedfishV1SFSSAppCDCInstanceManagers", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.DefaultAPI.PutRedfishV1SFSSAppCDCInstanceManagers(context.Background(), instanceId).Execute()
	...
	t.Run("Test DefaultAPIService PutRedfishV1SFSSAppIpAddressManagementsInterface", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var interfaceId string

		httpRes, err := apiClient.DefaultAPI.PutRedfishV1SFSSAppIpAddressManagementsInterface(context.Background(), interfaceId).Execute()
	...
	t.Run("Test DefaultAPIService PutRedfishV1SFSSApp_2", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.DefaultAPI.PutRedfishV1SFSSApp_0(context.Background()).Execute()
