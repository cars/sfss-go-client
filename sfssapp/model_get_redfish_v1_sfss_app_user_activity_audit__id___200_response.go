...
type GetRedfishV1SFSSAppUserActivityAuditID200Response struct {
	...
	// IP address of the system from which the specific user activity is performed
...
type _GetRedfishV1SFSSAppUserActivityAuditID200Response GetRedfishV1SFSSAppUserActivityAuditID200Response
...
func NewGetRedfishV1SFSSAppUserActivityAuditID200Response(cDCInstance string, hTTPCode string, operation string, payload string, sourceIP string, timeStamp string, uRL string, userAgent string, userName string, userRole string, odataId string, odataType string, odataContext string) *GetRedfishV1SFSSAppUserActivityAuditID200Response {
	this := GetRedfishV1SFSSAppUserActivityAuditID200Response{}
...
func (o GetRedfishV1SFSSAppUserActivityAuditID200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetRedfishV1SFSSAppUserActivityAuditID200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRedfishV1SFSSAppUserActivityAuditID200Response := _GetRedfishV1SFSSAppUserActivityAuditID200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRedfishV1SFSSAppUserActivityAuditID200Response)

	if err != nil {
		return err
	}

	*o = GetRedfishV1SFSSAppUserActivityAuditID200Response(varGetRedfishV1SFSSAppUserActivityAuditID200Response)

	return err
}

type NullableGetRedfishV1SFSSAppUserActivityAuditID200Response struct {
	value *GetRedfishV1SFSSAppUserActivityAuditID200Response
	isSet bool
}

func (v NullableGetRedfishV1SFSSAppUserActivityAuditID200Response) Get() *GetRedfishV1SFSSAppUserActivityAuditID200Response {
	return v.value
}

func (v *NullableGetRedfishV1SFSSAppUserActivityAuditID200Response) Set(val *GetRedfishV1SFSSAppUserActivityAuditID200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRedfishV1SFSSAppUserActivityAuditID200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRedfishV1SFSSAppUserActivityAuditID200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRedfishV1SFSSAppUserActivityAuditID200Response(val *GetRedfishV1SFSSAppUserActivityAuditID200Response) *NullableGetRedfishV1SFSSAppUserActivityAuditID200Response {
	return &NullableGetRedfishV1SFSSAppUserActivityAuditID200Response{value: val, isSet: true}
}

func (v NullableGetRedfishV1SFSSAppUserActivityAuditID200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRedfishV1SFSSAppUserActivityAuditID200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
