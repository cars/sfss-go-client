...
// checks if the UserActivityAuditGETUserActivityAuditsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserActivityAuditGETUserActivityAuditsInner{}

// UserActivityAuditGETUserActivityAuditsInner struct for UserActivityAuditGETUserActivityAuditsInner
type UserActivityAuditGETUserActivityAuditsInner struct {
	...
	// Date and time at which the operation was performed; the date is of the mm/dd/yyyy format and time is of the hh:mm:ss format
...
type _UserActivityAuditGETUserActivityAuditsInner UserActivityAuditGETUserActivityAuditsInner
...
func NewUserActivityAuditGETUserActivityAuditsInner(cDCInstance string, hTTPCode string, operation string, payload string, sourceIP string, timeStamp string, uRL string, userAgent string, userName string, userRole string, odataId string, odataType string, odataContext string) *UserActivityAuditGETUserActivityAuditsInner {
	this := UserActivityAuditGETUserActivityAuditsInner{}
...
func (o UserActivityAuditGETUserActivityAuditsInner) MarshalJSON() ([]byte, error) {
...
func (o UserActivityAuditGETUserActivityAuditsInner) ToMap() (map[string]interface{}, error) {
...
func (o *UserActivityAuditGETUserActivityAuditsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varUserActivityAuditGETUserActivityAuditsInner := _UserActivityAuditGETUserActivityAuditsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserActivityAuditGETUserActivityAuditsInner)

	if err != nil {
		return err
	}

	*o = UserActivityAuditGETUserActivityAuditsInner(varUserActivityAuditGETUserActivityAuditsInner)

	return err
}

type NullableUserActivityAuditGETUserActivityAuditsInner struct {
	value *UserActivityAuditGETUserActivityAuditsInner
	isSet bool
}

func (v NullableUserActivityAuditGETUserActivityAuditsInner) Get() *UserActivityAuditGETUserActivityAuditsInner {
	return v.value
}

func (v *NullableUserActivityAuditGETUserActivityAuditsInner) Set(val *UserActivityAuditGETUserActivityAuditsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUserActivityAuditGETUserActivityAuditsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUserActivityAuditGETUserActivityAuditsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserActivityAuditGETUserActivityAuditsInner(val *UserActivityAuditGETUserActivityAuditsInner) *NullableUserActivityAuditGETUserActivityAuditsInner {
	return &NullableUserActivityAuditGETUserActivityAuditsInner{value: val, isSet: true}
}

func (v NullableUserActivityAuditGETUserActivityAuditsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserActivityAuditGETUserActivityAuditsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
