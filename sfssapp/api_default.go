...
type ApiGetRedfishV1SFSSAppImagesRequest struct {
	ctx context.Context
	ApiService *DefaultAPIService
}

func (r ApiGetRedfishV1SFSSAppImagesRequest) Execute() (*GetRedfishV1SFSSAppImages200Response, *http.Response, error) {
	return r.ApiService.GetRedfishV1SFSSAppImagesExecute(r)
}

/*
GetRedfishV1SFSSAppImages Get all images

This API retrieves all the SFSS images available in the system.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetRedfishV1SFSSAppImagesRequest
*/
func (a *DefaultAPIService) GetRedfishV1SFSSAppImages(ctx context.Context) ApiGetRedfishV1SFSSAppImagesRequest {
	return ApiGetRedfishV1SFSSAppImagesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetRedfishV1SFSSAppImages200Response
func (a *DefaultAPIService) GetRedfishV1SFSSAppImagesExecute(r ApiGetRedfishV1SFSSAppImagesRequest) (*GetRedfishV1SFSSAppImages200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetRedfishV1SFSSAppImages200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetRedfishV1SFSSAppImages")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiPutRedfishV1SFSSApp_0Request) Execute() (*PutRedfishV1SFSSApp200Response, *http.Response, error) {
	return r.ApiService.PutRedfishV1SFSSApp_1Execute(r)
}
...
*/
func (a *DefaultAPIService) PutRedfishV1SFSSApp_1(ctx context.Context) ApiPutRedfishV1SFSSApp_0Request {
	return ApiPutRedfishV1SFSSApp_0Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return PutRedfishV1SFSSApp200Response
func (a *DefaultAPIService) PutRedfishV1SFSSApp_1Execute(r ApiPutRedfishV1SFSSApp_0Request) (*PutRedfishV1SFSSApp200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.PutRedfishV1SFSSApp_1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
